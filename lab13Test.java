...
class lab13Test {
	...
	void setUp() throws Exception {
		...
		try
		{
			...
			ArrayList<Integer> expected1 = testData.get(0);
			for(int i = 0; i < expected1.size(); i++) {
				expectedResult1[i] = expected1.get(i);
			}
			...
			ArrayList<Integer> expected2 = testData.get(1);
			for(int i = 0; i < expected2.size(); i++) {
				expectedResult2[i] = expected2.get(i);
			}
			...
			ArrayList<Integer> expected3 = testData.get(2);
			for(int i = 0; i < expected3.size(); i++) {
				expectedResult3[i] = expected3.get(i);
			}
